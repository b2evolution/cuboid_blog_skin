...
$params = array_merge( array(
		...
		'form_title_start'     => '<div id="comment_form" class="panel '.( $Session->get('core.preview_Comment') ? 'panel-danger' : 'panel-default' ).'">'
											.'<div class="panel-heading"><h4 class="panel-title"><i class="fa fa-comments-o"></i>',
